...
class CodeOptimizer {
     ...
     * 优化方法源代码
     */
    optimizeMethodSource(source, isEntryPoint = false) {
        let result = source;
        // 紧凑模式：非入口方法只保留签名
     ...
     * 优化 import 语句
     */
    optimizeImports(imports, methodSources) {
     ...
     * 移除简单注解（保留关键业务注解）
     */
    removeSimpleAnnotations(source) {
        // 要移除的注解列表
        const removeList = [
            '@Override',
            '@Deprecated',
